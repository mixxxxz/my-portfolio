  ...
  const projectsData = [
    {
      ...
      status: 'Completed',
      desc: 'ระบบเว็บไซต์อีคอมเมิร์ซสำหรับร้านเครื่องเขียน แบ่งการทำงานเป็น 2 ส่วนหลักคือ ฝั่งลูกค้า ที่สามารถเลือกซื้อสินค้าและชำระเงินผ่านระบบสแกนคิวอาร์โค้ด และฝั่งผู้ดูแลระบบ สำหรับสรุปยอดขาย จัดการสต็อกสินค้า และตรวจสอบคำสั่งซื้ออย่างเป็นระบบ',
      features: [
        'ลูกค้า (Customer): ค้นหาและแยกหมวดหมู่สินค้า (เช่น อุปกรณ์สำนักงาน, งานศิลปะ), ดูรายละเอียดสินค้า และจัดการตะกร้าสินค้า',
        'ระบบชำระเงิน: สรุปยอดสั่งซื้อ, สแกนชำระเงินผ่าน PromptPay QR Code และอัปโหลดสลิปหลักฐานการโอนเงิน',
        'แอดมิน (Admin): หน้าแสดงสถิติภาพรวม (จำนวนลูกค้า, ออเดอร์ทั้งหมด, รายได้รวม) และจัดอันดับสินค้าขายดี',
        'ระบบจัดการคลังสินค้า: เพิ่ม/ลบ/แก้ไขข้อมูลสินค้า',
        'ระบบจัดการคำสั่งซื้อ: ตรวจสอบสลิปโอนเงิน, อนุมัติ/ยกเลิกคำสั่งซื้อ และอัปเดตสถานะการจัดส่งพร้อมเลขพัสดุ'
      ],
